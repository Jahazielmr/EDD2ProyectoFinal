...
public class Main extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       DefaultMutableTreeNode Raiz = new DefaultMutableTreeNode(jPanel2.getName());
       DefaultMutableTreeNode nodoRegistro;
       nodoRegistro  = nodo_registro;
        
       DefaultMutableTreeNode reg = new DefaultMutableTreeNode();
       reg.setUserObject(fa);
       nodoRegistro.add (reg);
       Raiz.add(nodoRegistro);
           
        DefaultTreeModel modelo = new DefaultTreeModel(Raiz);
        
       arbolArchivo.setModel(modelo);
